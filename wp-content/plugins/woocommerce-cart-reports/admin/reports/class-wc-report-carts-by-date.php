...
class WC_Report_Carts_By_Date extends WC_Admin_Report {
	...
	public function get_chart_legend() {
		...
		$legend[] = array(
			'title' => sprintf( __( '%s abandoned carts in this period.', 'woocommerce' ), '<strong>' . sizeof($abandoned_carts) . '</strong>' ),
		...
		<script type="text/javascript">
			...
			jQuery(function(){
				...
				var drawGraph = function( highlight ) {
					var series = [
						{
							label: "<?php echo esc_js( __( 'Number of conversions', 'woocommerce' ) ) ?>",
						...
						{
							label: "<?php echo esc_js( __( 'Abandoned Carts', 'woocommerce' ) ) ?>",
