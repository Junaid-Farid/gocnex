 ...
 * @author      WooThemes
 * @category    Marketing
 * @copyright   Copyright (c) 2014, WooThemes
...
class WC_Pre_Orders {
	...
	public function add_pay_later_gateway( $gateways ) {
		...
		require_once( 'classes/gateways/class-wc-pre-orders-gateway-pay-later.php' );
	...
	public function add_email_classes( $email_classes ) {
		...
		foreach ( array( 'new-pre-order', 'pre-order-available', 'pre-order-cancelled', 'pre-order-date-changed', 'pre-ordered' ) as $class_file_name ) {
			require_once( "classes/emails/class-wc-pre-orders-email-{$class_file_name}.php" );
		}
