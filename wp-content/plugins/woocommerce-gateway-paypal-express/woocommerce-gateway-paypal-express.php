...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '3.1.0', __( 'WooCommerce PayPal Express Gateway', 'woocommerce-gateway-paypal-express' ), __FILE__, 'init_woocommerce_gateway_paypal_express', array( 'is_payment_gateway' => true, 'minimum_wc_version' => '2.1', 'backwards_compatible' => '3.1.0' ) );
...
/**
 * The WC_PayPal_Express global object, exists only for backwards compat
 *
 * @deprecated 3.3.0
 * @name $wc_paypal_express
 * @global WC_PayPal_Express $GLOBALS['wc_paypal_express']
 */
$GLOBALS['wc_paypal_express'] = wc_paypal_express();
